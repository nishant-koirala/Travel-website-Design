<?php
// Simple Enhanced Package Form - No Database Operations
// This form focuses on data collection and validation only
...
try {
    ...
    $databaseError = "Database connection issue: " . $e->getMessage();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Set success message if no errors and image uploaded
    if (empty($errors) && $imageUploaded) {
        $success = "Package '$title' and image uploaded successfully!";
    } elseif (empty($errors)) {
        $success = "Package '$title' data collected successfully!";
    }
}
    ...
    <div class="main-container">
        ...
        <?php if (!$databaseConnected): ?>
            <div class="alert alert-danger">
                ...
                <p><?php echo htmlspecialchars($databaseError); ?></p>
                <p>Please check your database connection settings and try again.</p>
            </div>
        <?php endif; ?>
        
        <form method="post" action="add_package_enhanced_process.php" enctype="multipart/form-data">
            <div class="form-container">
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <?php if ($imageRelativePath): ?>
                            <small>Current image: <?php echo htmlspecialchars($imageRelativePath); ?></small>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
        ...
        <?php if ($databaseConnected): ?>
            <div class="db-status">
                ...
                <p>Ready to create enhanced packages with all Nepali trekking details!</p>
            </div>
        <?php endif; ?>
    </div>

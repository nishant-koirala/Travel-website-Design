...
// Get current quota and actual usage
$quota = [];
$usage = [];
try {
    ...
    // Get actual API usage from chatbot_messages table
    $usageStmt = $pdo->query("SELECT COUNT(*) as total_calls FROM chatbot_messages WHERE sender = 'user' AND created_at >= DATE_SUB(NOW(), INTERVAL 30 DAY)");
    $usage = $usageStmt->fetch(PDO::FETCH_ASSOC);
    
} catch (PDOException $e) {
    error_log("API Usage Error: " . $e->getMessage());
...
<head>
    ...
    <title>API Usage Analytics - Travel Website Admin</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="main-content flex-grow-1 p-4">
        <div class="header mb-4">
            <h1 class="h3">📊 API Usage Analytics</h1>
            <p class="text-muted">Real-time tracking of your chatbot API calls and usage patterns</p>
        </div>
        
        <!-- Usage Statistics -->
        <div class="usage-card">
            <h4 class="mb-4">📈 Usage Statistics (Last 30 Days)</h4>
            ...
            <div class="usage-stat">
                ...
                <div class="stat-item">
                    ...
                    <div class="stat-label">Actual Calls Made</div>
                </div>
                <div class="stat-item">
            ...
            <?php if ($used >= $limit): ?>
                <div class="alert alert-warning mt-3">
                    ...
                    You've used <?php echo $used; ?> out of <?php echo $limit; ?> available calls.
                    <a href="payment.php?plan=pro" class="btn btn-warning btn-sm ms-2">Purchase More Credits</a>
                </div>
            <?php endif; ?>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <div class="plan-card">
                        ...
                        <button class="btn btn-outline-primary btn-purchase" onclick="purchasePlan('basic')">
                            Purchase Basic
                        </button>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-3">
                    <div class="plan-card recommended">
                        ...
                        <button class="btn btn-warning btn-purchase" onclick="purchasePlan('pro')">
                            Purchase Pro
                        </button>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-3">
                    <div class="plan-card">
                        ...
                        <button class="btn btn-success btn-purchase" onclick="purchasePlan('enterprise')">
                            Purchase Enterprise
                        </button>
                    </div>
                </div>
    ...
    <script>
        function purchasePlan(plan) {
            ...
            if (confirm('Purchase ' + plan + ' plan? This will take you to the payment page.')) {

...
try {
    ...
    $nepaliPackages = [
        ...
        5 => [
            ...
            'difficulty_level' => 'challenging',
            'accommodation_type' => 'Camping & Teahouses',
            'transportation' => 'Domestic flight + Private vehicle',
...
function getNepaliItinerary($packageId) {
    $itineraries = [
        ...
        2 => [ // Annapurna Circuit
            ...
            [2, 7, 'Annapurna Summit Day', 'Pre-dawn climb to Annapurna Summit (4,095m), spectacular sunrise views, celebration at peak.', 'Breakfast', 'Summit climb, Sunrise views', 'Annapurna Summit'],
            ...
            [2, 11, 'Siuli to Nayapul', 'Short trek back to Nayapul, farewell to porters, drive back to Kathmandu.', 'Breakfast, Lunch', 'Final trek, Farewell', 'Nayapul'],
            [2, 12, 'Drive to Kathmandu', 'Scenic drive back to Kathmandu, certificate distribution, farewell dinner.', 'Breakfast', 'Drive, Certificate', 'Kathmandu'],
            [2, 13, 'Rest Day in Kathmandu', 'Free day in Kathmandu, sightseeing, shopping, rest, celebration dinner.', 'Breakfast, Lunch, Dinner', 'Rest day, Sightseeing', 'Kathmandu'],
        ...
        3 => [ // Langtang Valley
            ...
            [3, 4, 'Langtang to Kyanjin Gompa', 'Trek to Kyanjin Gompa (3,500m), stunning views of Langtang Lirung, spiritual experience.', 'Breakfast, Lunch, Dinner', 'Monastery visit', Mountain views', 'Kyanjin Gompa'],
